...
CREATE TABLE gebieden_ggwgebieden_bestaat_uit_buurten (
    id character varying(255),
    ggwgebieden_id character varying(255),
    bestond_uit_buurten_id character varying(255),
    ggwgebieden_identificatie character varying(255),
    ggwgebieden_volgnummer integer,
...
INSERT INTO gebieden_ggwgebieden_bestaat_uit_buurten (id, ggwgebieden_id, bestond_uit_buurten_id,
    ggwgebieden_identificatie, ggwgebieden_volgnummer, bestond_uit_buurten_identificatie,
    bestond_uit_buurten_volgnummer) VALUES ('01.1.01.1', '01.1', '01.1', '01', 1, '01', 1);
