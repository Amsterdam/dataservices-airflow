...
airflow connections --delete --conn_id taxi_waarnemingen_conn_id
airflow connections --add  --conn_id taxi_waarnemingen_conn_id \
    --conn_host https://waarnemingen.amsterdam.nl \
    --conn_type http

airflow connections --delete --conn_id taxi_waarnemingen_acc_conn_id
airflow connections --add  --conn_id taxi_waarnemingen_acc_conn_id \
