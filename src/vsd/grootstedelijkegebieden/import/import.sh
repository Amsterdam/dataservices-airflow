...
ogr2ogr -f "PGDump" -lco FID=id -lco GEOMETRY_NAME=geometrie -nlt MULTIPOLYGON -nln gbd_grootstedelijke_projecten_new ${TMPDIR}/gbd_grootstedelijke_projecten.sql ${TMPDIR}/GBD_grootstedelijke_projecten.shp
...
ALTER INDEX gbd_grootstedelijke_projecten_new_geometrie_geom_idx RENAME TO gbd_grootstedelijke_projecten_geometrie_geom_idx;
COMMIT;
SQL
