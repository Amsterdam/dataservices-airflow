...
DAG_ID: Final = "ondergrond_az"
DATASET_ID: Final = "ondergrond"
...
with DAG(
    ...
    create_tables = [
        SqlAlchemyCreateObjectOperator(
            ...
            data_table_name=f"{DATASET_ID}_{table_name}",
            ind_table=True,
    ...
    GEOJSON_to_DB = [
        Ogr2OgrOperator(
            ...
            target_table_name=f"{DATASET_ID}_{table_name}_new",
    ...
    set_geo_datatype = [
        PostgresOnAzureOperator(
            ...
            params={
                "tablename": f"{DATASET_ID}_{table_name}_new",
    ...
    for table_name, _ in files_to_download.items():
        ...
        count_checks.append(
            COUNT_CHECK.make_check(
                ...
                pass_value=10,
                params={"table_name": f"{DATASET_ID}_{table_name}_new"},
        ...
        geo_checks.append(
            GEO_CHECK.make_check(
                ...
                params={
                    "table_name": f"{DATASET_ID}_{table_name}_new",
    ...
    drop_unnecessary_cols = [
        PostgresOnAzureOperator(
            task_id=f"drop_unnecessary_cols_{DATASET_ID}_{table_name}_new",
            sql=SQL_DROP_UNNECESSARY_COLUMNS_TMP_TABLE,
            params={"tablename": f"{DATASET_ID}_{table_name}_new"},
        )
        for table_name, _ in files_to_download.items()
    ...
    mask_value_column_auteur = [
        PostgresOnAzureOperator(
            task_id=f"mask_value_auteur_{DATASET_ID}_{table_name}_new",
    ...
    change_data_capture = [
        PostgresTableCopyOperator(
            ...
            dataset_name=DATASET_ID,
            source_table_name=f"{DATASET_ID}_{table_name}_new",
            target_table_name=f"{DATASET_ID}_{table_name}",
