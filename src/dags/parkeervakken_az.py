...
DAG_ID: Final = "parkeervakken_az"
DATASET_ID: Final = "parkeervakken"
# postgres_conn_id = "parkeervakken_postgres"
TMP_TABLE_PREFIX = "temp"
# CONFIG = Variable.get(DAG_ID, deserialize_json=True)

TABLES: Final = {
    "BASE": f"{DATASET_ID}_{DATASET_ID}",
    "BASE_TEMP": f"{DATASET_ID}_{DATASET_ID}_temp",
    "REGIMES": f"{DATASET_ID}_{DATASET_ID}_regimes",
    "REGIMES_TEMP": f"{DATASET_ID}_{DATASET_ID}_regimes_temp",
}
...
with DAG(
    ...
    create_temp_tables = PostgresOnAzureOperator(
        ...
        params={"base_table": f"{DATASET_ID}_{DATASET_ID}"},
    )
    ...
    count_check = PostgresMultiCheckOperator(
        ...
        checks=[
            COUNT_CHECK.make_check(
                ...
                pass_value=10,
                params={"table_name": f"{DATASET_ID}_{DATASET_ID}_temp"},
