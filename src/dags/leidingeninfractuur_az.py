...
DAG_ID: Final = "leidingeninfrastructuur_az"
DATASET_ID: Final = "leidingeninfrastructuur"
...
TABLES: Final[list[Table]] = [
    Table(
        id=f"{DATASET_ID}_{table_name}",
        base_id=table_name,
        tmp_id=f"{DATASET_ID}_{table_name}_{TMP_TABLE_POSTFIX}",
        sql_name=sql_name,
    )
