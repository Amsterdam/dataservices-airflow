...
DAG_ID: Final = "precariobelasting_az"
DATASET_ID: Final = "precariobelasting"
...
with DAG(
    ...
    import_data = [
        Ogr2OgrOperator(
            ...
            target_table_name=f"{DATASET_ID}_{file_name}_new",
            ...
            COUNT_CHECK.make_check(
                ...
                params={
                    "table_name": "{tmp_schema}.{dataset}_{table}_new".format(
                        tmp_schema=tmp_database_schema, dataset=DATASET_ID, table=file_name
                    )
                },
    ...
    add_title_columns = [
        PostgresOnAzureOperator(
            ...
            params={
                ...
                "tablenames": [f"{DATASET_ID}_{file_name}_new"],
            },
        )
        for file_name in data_endpoints.keys()
    ]
