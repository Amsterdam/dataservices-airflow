...
def setup_containers() -> dict[str, list]:
    ...
    # # TEST #
    containers2 = { k:v for k,v in containers.items() if k in ['container_0','container_1','container_2','container_3','container_4','container_5','container_6','container_7','container_8','container_9','container_rest']}
    return containers2
    # # TEST #
