...
CON2 = {k: CONTAINERS_TO_RUN_IN_PARALLEL[k] for k in list(CONTAINERS_TO_RUN_IN_PARALLEL)[5:15]}
CON3 = {k: CONTAINERS_TO_RUN_IN_PARALLEL[k] for k in list(CONTAINERS_TO_RUN_IN_PARALLEL)[15:20]}
