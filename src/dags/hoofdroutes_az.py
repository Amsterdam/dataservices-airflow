...
DAG_ID: Final = "hoofdroutes_az"
DATASET_ID: Final = "hoofdroutes"
...
with DAG(
    ...
    load_data = [
        Ogr2OgrOperator(
            ...
            target_table_name=f"{DATASET_ID}_{resource_name}_new",
    ...
    for resource_name in files_to_download:
        ...
        count_checks.append(
            COUNT_CHECK.make_check(
                ...
                pass_value=2,
                params={"table_name": f"{DATASET_ID}_{resource_name}_new"},
        ...
        geo_checks.append(
            GEO_CHECK.make_check(
                ...
                params={
                    "table_name": f"{DATASET_ID}_{resource_name}_new",
                    "geotype": [
                        "POINT",
                        "MULTILINESTRING",
                    ],
    ...
    change_data_capture = [
        PostgresTableCopyOperator(
            ...
            source_table_name=f"{DATASET_ID}_{resource_name}_new",
            target_table_name=f"{DATASET_ID}_{resource_name}",
    ...
    clean_ups = [
        PostgresOnAzureOperator(
            ...
            sql=SQL_DROP_TABLE,
            params={"tablename": f"{DATASET_ID}_{resource_name}_new"},
        )
        for resource_name in files_to_download
    ]
