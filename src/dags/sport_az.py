...
with DAG(
    ...
    load_data = [
        Ogr2OgrOperator(
            ...
            target_table_name=f"{DATASET_ID}_{resource}_new",
    ...
    add_geom_col = [
        PostgresOnAzureOperator(
            ...
            params={"tablename": f"{DATASET_ID}_{resource}"},
        )
    ...
    lookup_geometry_typeahead = [
        TypeAHeadLocationOperator(
            ...
            source_table=f"{DATASET_ID}_{resource}_new",
    ...
    geom_valid = [
        PostgresOnAzureOperator(
            ...
            params={"tablename": f"{DATASET_ID}_{resource}_new"},
        )
        ...
        for resource in resources:
            ...
            count_checks.append(
                COUNT_CHECK.make_check(
                    ...
                    pass_value=2,
                    params={"table_name": f"{DATASET_ID}_{resource}_new"},
            ...
            geo_checks.append(
                GEO_CHECK.make_check(
                    ...
                    params={
                        "table_name": f"{DATASET_ID}_{resource}_new",
                        "geotype": [
                            "POINT",
                            "POLYGON",
                            "MULTIPOLYGON",
    ...
    create_tables = [
        SqlAlchemyCreateObjectOperator(
            ...
            data_table_name=f"{DATASET_ID}_{resource}",
            ind_table=True,
    ...
    change_data_capture = [
        PostgresTableCopyOperator(
            ...
            source_table_name=f"{DATASET_ID}_{resource}_new",
            target_table_name=f"{DATASET_ID}_{resource}",
