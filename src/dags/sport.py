...
def clean_data(file_name):
    ...
    # the source seems to have the replacement karakter in it without no possibity to transform it anymore
    remove_unkown_karakter = re.sub(u'\uFFFD', u"\u2014", remove_double_spaces)
...
with DAG(
    ...
    cleanse_data = [ 
        PythonOperator(
            ...
            op_args=[f"{tmp_dir}/{file_name}.sql",]
        )
