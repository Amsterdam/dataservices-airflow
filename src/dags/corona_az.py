...
DAG_ID: Final = "corona_az"
DATASET_ID: Final = "corona"
...
with DAG(
    ...
    import_OOV_data = PythonOperator(
        ...
        op_kwargs={
            ...
            "db_table_name": f"{DATASET_ID}_handhaving_new",
        },
    )
    ...
    import_RIVM_data = PythonOperator(
        ...
        op_kwargs={
            ...
            "db_table_name": f"{DATASET_ID}_gevallen_new",
        },
    )
    ...
    rename_tables = [
        PostgresTableRenameOperator(
            ...
            old_table_name=f"{DATASET_ID}_{table_name}_new",
            new_table_name=f"{DATASET_ID}_{table_name}",
        )
    ...
    check_count = [
        PostgresCheckOperator(
            ...
            sql=SQL_CHECK_COUNT,
            params={"tablename": f"{DATASET_ID}_{table_name}", "mincount": 10},
        )
        for table_name in database_table_names
    ]
