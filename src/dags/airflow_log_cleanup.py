...
# )
DEFAULT_MAX_LOG_AGE_IN_DAYS = env("AIRFLOW_LOG_CLEANUP__MAX_LOG_AGE_IN_DAYS")
...
LOG_CLEANUP_PROCESS_LOCK_FILE = f"{SHARED_DIR}/airflow_log_cleanup_worker.lock"
